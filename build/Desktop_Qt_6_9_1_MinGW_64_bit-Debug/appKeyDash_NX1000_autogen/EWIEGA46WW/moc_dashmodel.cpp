...
template <> constexpr inline auto DashModel::qt_create_metaobjectdata<qt_meta_tag_ZN9DashModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onSignal'
        QtMocHelpers::SlotData<void(const SignalUpdate &)>(48, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 49, 50 },
        }}),
        // Slot 'applySample'
        QtMocHelpers::SlotData<void(double, double, double, double, double, double, double, int)>(51, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Double, 52 }, { QMetaType::Double, 53 }, { QMetaType::Double, 54 }, { QMetaType::Double, 55 },
            { QMetaType::Double, 56 }, { QMetaType::Double, 57 }, { QMetaType::Double, 58 }, { QMetaType::Int, 22 },
        }}),
        // Slot 'setGearRatio'
        QtMocHelpers::SlotData<void(int, double)>(59, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 22 }, { QMetaType::Double, 23 },
        }}),
        // Slot 'loadVehicleConfig'
        QtMocHelpers::SlotData<bool(const QString &)>(60, 2, QMC::AccessPublic, QMetaType::Bool, {{
            { QMetaType::QString, 61 },
        }}),
        // Slot 'loadVehicleConfig'
        QtMocHelpers::SlotData<bool()>(60, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Bool),
        // Method 'gearRatio'
        QtMocHelpers::MethodData<double(int) const>(62, 2, QMC::AccessPublic, QMetaType::Double, {{
            { QMetaType::Int, 22 },
        }}),
        // Method 'setReplayMode'
        QtMocHelpers::MethodData<void(bool)>(63, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 64 },
        }}),
        // Method 'ingestFrame'
        QtMocHelpers::MethodData<void(const QVariantMap &)>(65, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 66, 2 },
        }}),
        // Method 'resetTrip'
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        // property 'rpm'
        QtMocHelpers::PropertyData<double>(52, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 1),
        // property 'boost'
        QtMocHelpers::PropertyData<double>(54, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 2),
        // property 'clt'
        QtMocHelpers::PropertyData<double>(55, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 3),
        // property 'iat'
        QtMocHelpers::PropertyData<double>(56, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 4),
        // property 'vbat'
        QtMocHelpers::PropertyData<double>(57, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 5),
        // property 'afr'
        QtMocHelpers::PropertyData<double>(58, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 6),
        // property 'gear'
        ...
        QtMocHelpers::PropertyData<QString>(69, QMetaType::QString, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 8),
        // property 'odo'
        QtMocHelpers::PropertyData<double>(70, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 9),
        // property 'trip'
        QtMocHelpers::PropertyData<double>(71, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 10),
        // property 'leftSignal'
        QtMocHelpers::PropertyData<bool>(72, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 11),
        // property 'rightSignal'
        QtMocHelpers::PropertyData<bool>(73, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 12),
        // property 'headlightsOn'
        QtMocHelpers::PropertyData<bool>(74, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 13),
        // property 'celOn'
        QtMocHelpers::PropertyData<bool>(75, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 14),
        // property 'tcsOn'
        QtMocHelpers::PropertyData<bool>(76, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 15),
        // property 'useMph'
        QtMocHelpers::PropertyData<bool>(77, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 16),
        // property 'rpmMax'
        QtMocHelpers::PropertyData<int>(78, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 17),
        // property 'finalDrive'
        QtMocHelpers::PropertyData<double>(79, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 18),
        // property 'z60Popup'
        QtMocHelpers::PropertyData<bool>(80, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 20),
        // property 'connected'
...
void DashModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 42: _t->onSignal((*reinterpret_cast< std::add_pointer_t<SignalUpdate>>(_a[1]))); break;
        case 43: _t->applySample((*reinterpret_cast< std::add_pointer_t<double>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[5])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[6])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[7])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[8]))); break;
        case 44: _t->setGearRatio((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[2]))); break;
        case 45: { bool _r = _t->loadVehicleConfig((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 46: { bool _r = _t->loadVehicleConfig();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 47: { double _r = _t->gearRatio((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])));
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 48: _t->setReplayMode((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 49: _t->ingestFrame((*reinterpret_cast< std::add_pointer_t<QVariantMap>>(_a[1]))); break;
        case 50: _t->resetTrip(); break;
        default: ;
        }
    }
