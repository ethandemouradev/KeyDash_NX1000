...
template <> constexpr inline auto FileReader::qt_create_metaobjectdata<qt_meta_tag_ZN10FileReaderE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Method 'readUrl'
        QtMocHelpers::MethodData<QString(const QUrl &)>(1, 2, QMC::AccessPublic, QMetaType::QString, {{
            { QMetaType::QUrl, 3 },
        }}),
        // Method 'readTextUrl'
        QtMocHelpers::MethodData<QString(const QUrl &) const>(4, 2, QMC::AccessPublic, QMetaType::QString, {{
            { QMetaType::QUrl, 3 },
        }}),
    };
...
void FileReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { QString _r = _t->readUrl((*reinterpret_cast< std::add_pointer_t<QUrl>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 1: { QString _r = _t->readTextUrl((*reinterpret_cast< std::add_pointer_t<QUrl>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
